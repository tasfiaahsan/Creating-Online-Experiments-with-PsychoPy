...
At the end of the survey, we want to redirect the participant to the experiment. Select End of Survey --> Redirect to URL: paste the link of your experiment in the box below (will be edited in Chapter 6 for automatic crediting).
...
Pro: Free
Con: looks very chunky, data is together with demographics information.
