...
```
If you pushed the first button, you should see a warning screen open up as shown below. All PyschoPy experiments are set to Inactive by default so we ened to click on the experiment page and set it to running. Then we are able to run the experiment by clicking the link or the run button. 
